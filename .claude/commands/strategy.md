...
Last strategic decision: <one line — most recent strategic call>
```
...
- **MCP scope:** `shishka-mission-control__*` for writes in non-tech domains; `shishka-chef` / `shishka-finance` read-only
