...
import { resolve, type PackInfoDataProvider, type ResolverResult } from '../pack-info-resolver/index.ts';
import { hasRecentSkipDecision } from './cooldown.ts';
import { writeAutoApply, writePending, writeSkip } from './decisions-writer.ts';
import {
