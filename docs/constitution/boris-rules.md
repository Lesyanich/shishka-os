...
1. Create or update an architecture note (`.md`) in `vault/` using Obsidian Flavored Markdown (wikilinks, frontmatter tags, callouts).
...
1. `STATUS.md` — updated to reflect changes
2. `vault/Architecture/Database Schema.md` — updated if any migration touched tables, policies, RPCs, or ENUMs
