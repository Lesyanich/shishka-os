...
-> Shared domain: `docs/context/shared/uom.md`, `docs/context/shared/supplier-domain.md`
-> Schema: `04_Knowledge/Architecture/Database Schema.md`
-> Phase history: `docs/context/phases/phase-4-procurement.md`
-> Architecture: `04_Knowledge/Architecture/Procurement & Receiving Architecture.md`
