...
| Минимальная ЗП (Phuket) | 400 THB/день |
...
> **Канонический справочник:** полная база знаний по тайскому трудовому праву, праздникам, увольнениям и культуре работы с тайскими сотрудниками — [docs/guides/hr-labour-code.md](../guides/hr-labour-code.md). Эта таблица — выдержка для расчётов; при расхождении приоритет у guide (там источники + даты сверки).
...
4. **Минимальная ЗП** — Phuket = 400 THB/день. Валидация при создании staff с contract_type=daily.
...
8. **Не пушить без:** обновления STATUS.md + db-schema-summary.md (RULE-COMMIT-GATE).
