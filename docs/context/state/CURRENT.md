...
**Latest migration:** 068 (data quality: UoM normalization, name_th NOT NULL, nutrition gaps, WHT percent)
...
|---------|--------|------------|
| **admin-panel** | Active (Phase 17) | `docs/context/projects/admin/CURRENT.md` |
