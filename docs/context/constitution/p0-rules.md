...
5. **State Management:** Always read `docs/context/state/CURRENT.md` before starting a task and update it after completion.
...
If you make a mistake and the user corrects you, you MUST update the relevant file in `docs/context/` to ensure you NEVER make this mistake again.
